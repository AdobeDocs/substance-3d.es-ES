...
breadcrumb-title: ''
description: Use los nodos Blueprint en Unreal Engine 4 para controlar los materiales de Substance en tiempo de ejecución para los flujos de trabajo de materiales dinámicos.
...
Esta sección detalla cómo trabajar con materiales de Substance y [Planos](https://docs.unrealengine.com/en-US/Engine/Blueprints/GettingStarted/index.html) en Unreal Engine.
