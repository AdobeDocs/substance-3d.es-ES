---
helpx_url: "https://helpx.adobe.com/es/substance-3d-integrations/game-engines/unity/changing-parameters.html"
breadcrumb-title: ''
...
1. **Generar Mapas Mip**: Generará texturas mip para cada salida del Substance.
1. **Raíz aleatoria**: Este botón cambiará la velocidad aleatoria que utiliza el gráfico del Substance para generar las texturas. Si se cambia este valor, se creará un nuevo resultado para la textura calculada en función del valor de inicialización.
