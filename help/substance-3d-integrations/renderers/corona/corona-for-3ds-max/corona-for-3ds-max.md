...
Con el [plugin 3ds Max](../../../3d-applications/3ds-max/3ds-max.md), puedes elegir Corona en el menú Substance para configurar automáticamente el material de Corona con entradas de textura Substance.
