...
* *Los materiales no se actualizan en la vista de procesamiento Ciclos*.
  * De forma predeterminada, el complemento no actualiza las texturas en la vista de procesamiento Ciclos. Sin embargo, se pueden actualizar a la fuerza habilitando <b>texturas de actualización automática de ciclos</b> en las preferencias del complemento.
...
* *Los materiales ya no se actualizan después de deshacer o cambiar los parámetros.*
  * Los materiales pueden no actualizarse después de deshacer las acciones. Aunque los parámetros volverán al estado anterior, las texturas no se desharán para que coincidan. Para actualizar de nuevo la textura, utilice el botón Actualizar para devolver los parámetros a sus valores por defecto y volver a cargar las texturas.
* *Los colores definidos en Substance Designer aparecen de forma ligeramente diferente en el selector de color de Blender y los valores de color no son los mismos.*
  * Blender aplica una corrección de gamma a los colores solo del selector de color de Blender. Si bien esto provoca una discrepancia en el selector de color, los colores que aparecen en las texturas son precisos para los valores establecidos en las aplicaciones de Substance.
...
* *Las modificaciones en el gráfico de sombreador se deshacen al utilizar el botón Actualizar o al actualizar parámetros.*
