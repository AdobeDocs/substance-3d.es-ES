...
breadcrumb-title: ''
description: Entender cómo funcionan los nodos de salida Substance en Maya para conectar texturas computadas a redes de sombreador.
...
En este nodo, puede ver la información de salida, como el Identificador, la etiqueta y el uso establecidos en la salida de Substance Designer. Este nodo también permite Hacer un bake la textura en disco en la sección Caché de resultados.
