...
El baker Posición calcula la ubicación de la geometría de malla y la guarda en una textura. La posición es útil para calcular información en el volumen del objeto o para crear máscaras de degradado.
...
| --- | --- |
| **Modo** | Controla la información que se calculará en la textura de posición.Valores posibles:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Todos los ejes:</strong> Hace un bake la posición de los ejes X, Y y Z en los canales de RGB de la textura de salida.</li><li data-preserve-html="true"><strong>Un eje:</strong> Hace un bake un solo eje en la textura de salida como una imagen en escala de grises.</li></ul> |
