...
| **Tipo de mapa** | Define el tipo de textura de salida.Valores posibles:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Espacio mundial</strong></li><li data-preserve-html="true"><strong>Espacio tangente</strong> (predeterminado)</li></ul> |
| **Orientación normal** | Controla el formato normal de la textura de salida si **Mat Type** está establecido en Espacio de tangente.Valores posibles:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>OpenGL</strong> <strong> <br/></strong></li><li data-preserve-html="true"><strong>DirectX</strong> (predeterminado)<strong> <br/></strong></li></ul> |
