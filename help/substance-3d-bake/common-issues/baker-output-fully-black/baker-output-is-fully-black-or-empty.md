...
> **Problema**
> 
> El resultado de un baker es una textura negra o vacía:
> 
> ![](../../assets/black.png)
...
> **Explicación**
> 
> Una textura negra significa que el baker no pudo encontrar la información necesaria para generar un resultado. Por ejemplo, el proceso de hacer un bake no encontró la malla de alto contenido de poli para que coincida con la malla de bajo contenido de poli, lo que da como resultado nada con lo que comparar.

>[!NOTE]
>
> **Solución**
> 
> * Compruebe si la malla de alta densidad necesaria para el baker se ha cargado correctamente (consulte el archivo de registro/ventana para ver los errores).
...
> * Compruebe si el baker pudo leer o procesar la malla (consulte el archivo de registro/ventana para ver los errores).
